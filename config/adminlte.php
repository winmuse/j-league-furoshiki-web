...
return [
    ...
    */
    ...
    'logo' => 'J-League Furoshiki',
    'logo_img' => 'vendor/adminlte/dist/img/AdminLTELogo.png',
    'logo_img_class' => 'brand-image-xl',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'J-League',
...
/*                [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => '不定期ハッシュタグ一覧',
                    'url' => 'admin/expire/tags',
                    'icon_color' => 'aqua'
                ],
                [
                    'text' => '新規追加',
                    'url' => 'admin/expire/tags/create',
                    'icon_color' => 'red'
                ]
            ]
        ],
        ...
        [
            'text' => '画像・動画の利用履歴',
            'icon' => 'fas fa-fw fa-link',
            'url'  => 'admin/media/usages',
            'role' => 'j-league,balz,club'
        ],
        [
            'text' => 'Dropbox管理',
            'icon' => 'fas fa-fw fa-link',
