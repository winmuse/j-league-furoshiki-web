...
@section('title', '定型ハッシュタグ一覧｜定型ハッシュタグ管理')
@section('content_header_label')
    <h1>定型ハッシュタグ一覧<a href="{{ route('admin.tags.create') }}" class="btn btn-success ml-2">追加</a></h1>
@stop

@php
/** @var App\Models\Master\Tag[] $tags */
@endphp
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right d-flex justify-content-around" style="width: 140px;">
                            <a href="{{ route('admin.tags.edit', ['id' => $tag->id]) }}" class="btn btn-sm btn-info">編集</a>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['route' => 'admin.tags.delete', 'method' => 'DELETE']) !!}
